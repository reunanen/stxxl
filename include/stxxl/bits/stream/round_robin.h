...
#ifndef STXXL_STREAM_ROUND_ROBIN_HEADER
#define STXXL_STREAM_ROUND_ROBIN_HEADER
...
//! Fetch data from different inputs, in a round-robin fashion.
//!
//! Template parameters:
...
#endif // !STXXL_STREAM_ROUND_ROBIN_HEADER
// vim: et:ts=4:sw=4
